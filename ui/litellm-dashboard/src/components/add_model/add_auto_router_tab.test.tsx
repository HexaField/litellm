...
describe("AddAutoRouterTab", () => {
  ...
  describe("template presets", () => {
    ...
    // buildPresetPrefill, the tier editor's state and serializeTierModelConfigs each drop these
    // params silently, and nothing between the bundled JSON and the payload asserted on them.
